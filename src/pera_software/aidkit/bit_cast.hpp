// From: https://chromium.googlesource.com/chromium/src.git/+/master/base/bit_cast.h:
...
// Ensure that memcpy will be replaced by intrinsics:
...
namespace pera_software::aidkit {
	...
	template <class Dest, class Source>
		inline Dest bit_cast( const Source& source )
		{
			...
			static_assert( std::is_trivially_copyable<Dest>::value, "non-trivially-copyable bit_cast is undefined" );
			static_assert( std::is_trivially_copyable<Source>::value, 	"non-trivially-copyable bit_cast is undefined" );
