...
#define AIDKIT_PRAGMA(text) _Pragma(#text)
	...
	#define AIDKIT_CLANG_PUSH_WARNINGS()
	#define AIDKIT_CLANG_POP_WARNINGS()
	#define AIDKIT_CLANG_DISABLE_WARNING(text)
	#define AIDKIT_CLANG_ENABLE_WARNING(text)

	#define AIDKIT_MSVC_PUSH_WARNINGS()
	#define AIDKIT_MSVC_POP_WARNINGS()
	...
	#define AIDKIT_GCC_PUSH_WARNINGS()
	#define AIDKIT_GCC_POP_WARNINGS()
	#define AIDKIT_GCC_DISABLE_WARNING(text)
	#define AIDKIT_GCC_ENABLE_WARNING(text)
