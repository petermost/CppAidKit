...
#define AIDKIT_PRAGMA(text) _Pragma(#text)
	...
	#define AIDKIT_PRAGMA_GCC_WARNING_PUSH()        AIDKIT_PRAGMA_GCC_DIAGNOSTIC(push)
	#define AIDKIT_PRAGMA_GCC_WARNING_POP()         AIDKIT_PRAGMA_GCC_DIAGNOSTIC(pop)
	...
	#define AIDKIT_PRAGMA_CLANG_DIAGNOSTIC(text)      AIDKIT_PRAGMA(clang diagnostic text)
	#define AIDKIT_PRAGMA_CLANG_WARNING_PUSH()        AIDKIT_PRAGMA_CLANG_DIAGNOSTIC(push)
	#define AIDKIT_PRAGMA_CLANG_WARNING_POP()         AIDKIT_PRAGMA_CLANG_DIAGNOSTIC(pop)
	#define AIDKIT_PRAGMA_CLANG_WARNING_DISABLE(text) AIDKIT_PRAGMA_CLANG_DIAGNOSTIC(ignored AIDKIT_JOIN_STRINGIFY(-W, text))
	#define AIDKIT_PRAGMA_CLANG_WARNING_ENABLE(text)  AIDKIT_PRAGMA_CLANG_DIAGNOSTIC(warning AIDKIT_JOIN_STRINGIFY(-W, text))
#endif

#if defined(AIDKIT_MSVC)
	#define AIDKIT_PRAGMA_MSVC_DIAGNOSTIC(text)        AIDKIT_PRAGMA(warning(text))
	#define AIDKIT_PRAGMA_MSVC_WARNING_PUSH()          AIDKIT_PRAGMA_MSVC_DIAGNOSTIC(push)
	#define AIDKIT_PRAGMA_MSVC_WARNING_POP()           AIDKIT_PRAGMA_MSVC_DIAGNOSTIC(pop)
	...
	#define AIDKIT_PRAGMA_GCC_WARNING_DISABLE(text)
	#define AIDKIT_PRAGMA_CLANG_WARNING_DISABLE(text)
	#define AIDKIT_PRAGMA_CLANG_WARNING_DISABLE(text)
#endif
